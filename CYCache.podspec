#
#  Be sure to run `pod spec lint CYCache.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author    = "成焱"
  # spec.authors            = { "成焱" => "chengyan5535@dingtalk.com" }
  # spec.social_media_url   = "https://twitter.com/成焱"
  ...
  spec.source_files  = "CYCache", "CYCache/*/*.{h,m}"
